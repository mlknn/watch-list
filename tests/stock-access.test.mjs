...
test('changing the URL cannot access another member’s stock or an untracked stock',async()=>{for(const symbol of ['CRDO','AMZN'])await assert.rejects(requireStockAccess(request,symbol,authenticate),e=>e.status===403);});
