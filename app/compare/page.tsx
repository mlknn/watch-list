...
export const metadata: Metadata = {
  ...
  description: 'Yahoo, Google, and TradingView show today’s price. StockWatchlist freezes the add-day price for a what-if portfolio. US, Europe, Canada, and Turkey. Not a broker.',
...
export default function Compare() {
  return <>
    ...
    <main className="privacy-page compare-page">
      ...
      <p>Yahoo Finance, Google Finance, and TradingView are excellent at showing what a ticker does <em>today</em>. StockWatchlist answers a narrower question: what happened after you put a number on an idea. The add-day price (and optional cost, shares, and purchase date) stay frozen. Separate lists for USD, EUR, CAD, and TRY. It is not a broker and not investment advice. Quotes are delayed public data.</p>
