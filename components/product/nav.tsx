...
export function PublicNav() {
 ...
 return <header className="topbar public-nav"><Brand/><nav aria-label="Main navigation">{member?<a className="solid-link" href="/watchlists"><T text="My watchlists"/></a>:<><a className="nav-extra" href="/dashboard"><T text="Dashboard"/></a><a className="nav-extra" href="/#about"><T text="About"/></a><a className="nav-extra" href="/pricing"><T text="Pricing"/></a><a className="nav-extra" href="/privacy"><T text="Privacy"/></a><a className="nav-extra" href="/login"><T text="Log in"/></a><a className="solid-link" href="/watchlists"><T text="Build a portfolio"/><ArrowUpRight size={16}/></a></>}</nav></header>;
}

export function PublicFooter() {
 const member=useMember();
 return <footer className="public-footer"><Brand/><LanguageSelect/><p className="footer-tagline"><T text="Good ideas deserve a starting point."/></p><nav className="footer-links" aria-label="Footer"><a href="/dashboard"><T text="Dashboard"/></a>{member&&<a href="/watchlists"><T text="My watchlists"/></a>}<a href="/#about"><T text="About"/></a><a href="/compare"><T text="Compare"/></a><a href="/open-source"><T text="Open source"/></a><a href="https://github.com/mlknn/watch-list" rel="noopener noreferrer"><T text="GitHub"/></a><a href="/privacy"><T text="Privacy"/></a><a href="/pricing"><T text="Plans"/></a>{member&&<a href="/account"><T text="Account"/></a>}{member?<SignOutButton/>:<a href="/login"><T text="Log in"/></a>}</nav></footer>;
}
