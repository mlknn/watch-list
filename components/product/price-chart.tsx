...
function CandleChart({data,compact,className,upColor,downColor}:{data:MarketChart;compact:boolean;className?:string;upColor:string;downColor:string}){
