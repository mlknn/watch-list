...
export function StockSearch({value,onChange,inputRef,onPick,currency,placeholder}:{value:string;onChange:(value:string)=>void;inputRef:RefObject<HTMLInputElement|null>;onPick?:(symbol:string)=>void;currency?:string;placeholder?:string}){const t=useT();
