...
export function StockSearch({value,onChange,inputRef,onPick,currency,placeholder,inputId}:{value:string;onChange:(value:string)=>void;inputRef:RefObject<HTMLInputElement|null>;onPick?:(symbol:string)=>void;currency?:string;placeholder?:string;inputId?:string}){const t=useT();
